"Frizza" by Franziska Geilen Kirchner
...
[Bloo City]
The Verge_Frizza is north of the Upper Desert_Frizza. The printed name of the Verge_Frizza is "Verge of the Bloo City". The description of the Verge_Frizza is "An averagely sized city extends in front of you. Its cityscape is dominated by an enormous building in the rear part, not resembling any architecture that you have ever seen. Halfway to it there seems to lie some sort of city center. The city is surrounded by a foreign sort of fencing, with a gate not far form you. You could approach, but you don't even know how this species is called."
...
Nox_Frizza is a person in the Sanctuary_Frizza. The printed name of Nox_Frizza is "Nox".

Kollock_Frizza is a person in the Citadel_Frizza. The printed name of Kollock_Frizza is "Elder Kollock".

Du'un_Frizza is a person in the Upper Gate_Frizza. The printed name of Du'un_Frizza is "Keeper Du'un".

Trapist_Frizza is a person in the Scoop_Frizza. The printed name of Trapist_Frizza is "Foreman Trapist".

BOT_Frizza is a person in the Control Tower_Frizza. The printed name of BOT_Frizza is "Central Cybernetic Unit B.O.T.".

Hisbald_Frizza is a person in the Tunnels_Frizza. The printed name of Hisbald_Frizza is "Hermit Hisbald".
